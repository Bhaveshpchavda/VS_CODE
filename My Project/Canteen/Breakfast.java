...
/**
 * used Trie datastructure for storing items value
 */
public class Breakfast {
    ...
    /* Display all store items in trie*/
    public void display(){
        System.out.println("Name of Item\tQuantity\tPrice\tMON|TUE|WED|THU|FRI");
        display_items(root, "");
    }
    
    /* Recursive function for display all stored value in trie*/
     ...
     * return  object of searched item.
     */
    public Item search(String word, int quantity, int day) {
        ...
        return new Item(current.name, quantity, current.price * quantity, "breakfast", current.days_available);
    }
